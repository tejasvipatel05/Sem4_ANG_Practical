...
@Component({
    selector: 'app-single-dimensional',
    imports: [FormsModule, NgFor, CommonModule],
    templateUrl: './single-dimensional.component.html',
    styleUrl: './single-dimensional.component.css'
})
export class SingleDimensionalComponent {
